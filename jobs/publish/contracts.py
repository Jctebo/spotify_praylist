...
def _shared_intro_context(
    *,
    ...
    return {
        ...
        "selected_observance": _compact_text(daily_payload.get("feastDay") or daily_payload.get("primaryAnchor")),
        "primary_anchor": _compact_text(daily_payload.get("feastDay") or daily_payload.get("primaryAnchor")),
        "selected_observance_date": _compact_text(daily_payload.get("primaryAnchorDate")),
        "primary_anchor_date": _compact_text(daily_payload.get("primaryAnchorDate")),
        "selected_observance_rank": _compact_text(daily_payload.get("primaryAnchorRank") or daily_payload.get("liturgicalRank")),
        "primary_anchor_rank": _compact_text(daily_payload.get("primaryAnchorRank") or daily_payload.get("liturgicalRank")),
        "selected_observance_timing": _compact_text(daily_payload.get("primaryAnchorTiming")),
        "selection_source": _compact_text(daily_payload.get("selectionSource")),
    ...
    *,
    ...
    if isinstance(helper_payload, dict):
        ...
        helper = DailyLiturgicalContext(
            ...
            sharedThemeVersion=str(helper_payload.get("sharedThemeVersion", "shared-liturgical-theme-v2")),
            ...
            primaryAnchorDate=str(helper_payload.get("primaryAnchorDate", "")),
            primaryAnchorRank=str(helper_payload.get("primaryAnchorRank", "")),
            primaryAnchorTiming=str(helper_payload.get("primaryAnchorTiming", "")),
            selectionSource=str(helper_payload.get("selectionSource", "")),
        )
    else:
