...
def build_daily_intro_result(
    ...
    *,
    ...
    intro_context = {
        ...
        "celebration_clause": _shared_theme_value(shared_theme, "feastDay") or _shared_theme_value(shared_theme, "primaryAnchor") or context.celebration_clause,
        "selected_observance": _shared_theme_value(shared_theme, "feastDay") or _shared_theme_value(shared_theme, "primaryAnchor") or context.celebration_clause,
        "primary_anchor": _shared_theme_value(shared_theme, "feastDay") or _shared_theme_value(shared_theme, "primaryAnchor") or context.celebration_clause,
        "selected_observance_date": _shared_theme_value(shared_theme, "primaryAnchorDate") or _shared_theme_value(shared_theme, "primary_anchor_date"),
        "primary_anchor_date": _shared_theme_value(shared_theme, "primaryAnchorDate") or _shared_theme_value(shared_theme, "primary_anchor_date"),
        "selected_observance_rank": _shared_theme_value(shared_theme, "primaryAnchorRank") or _shared_theme_value(shared_theme, "primary_anchor_rank"),
        "primary_anchor_rank": _shared_theme_value(shared_theme, "primaryAnchorRank") or _shared_theme_value(shared_theme, "primary_anchor_rank"),
        "selected_observance_timing": _shared_theme_value(shared_theme, "primaryAnchorTiming") or _shared_theme_value(shared_theme, "primary_anchor_timing"),
        "selection_source": _shared_theme_value(shared_theme, "selectionSource") or _shared_theme_value(shared_theme, "selection_source"),
