...
from jobs.publish.audio import ensure_podcast_cover_art, github_pages_base_url, load_published_audio_jobs, podcast_cover_art_public_url
...
def build_novena_rss_feed(*, docs_root: Optional[Path] = None, base_url: Optional[str] = None):
    ...
    jobs = load_published_audio_jobs(docs_root=root, base_url=base_url or github_pages_base_url())
    cover_art_url = podcast_cover_art_public_url(base_url=base_url or github_pages_base_url())
    return build_rss_feed(jobs, base_url=base_url or github_pages_base_url(), cover_art_url=cover_art_url)
