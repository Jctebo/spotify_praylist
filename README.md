...
- Publish-audio contract jobs resolve one deterministic saint-centered theme brief per target date, timezone, calendar, and locale from the inclusive D-3 through D+9 liturgical window, then reuse that brief across the existing Morning Prayer, Daily Rosary, Daily Reflection, Auxilium Christianorum, and Marian Antiphon jobs. The target-day anchor is primary; surrounding observances support continuity and never override it.
