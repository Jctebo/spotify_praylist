...
- Daily Reflection publishes as its own date-scoped Ora Pro Nobis episode with a shared daily liturgical context helper, a short pause-rich Ignatian-style reflection, a guided examen, deterministic fallback text when OpenAI is unavailable, and sidecar metadata for the helper/reflection source.
