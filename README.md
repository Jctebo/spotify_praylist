...
- Auxilium Christianorum and Marian Antiphon episodes use deterministic `prayer_intro` bridge blocks so the liturgical day announcement flows into the prayer with one concise shared-theme transition sentence.
