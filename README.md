...
- Generated, short-form, and traditional novenas receive one generated 1–2 sentence day/saint/shared-theme bridge before the existing novena prayer text; the novena body remains saint/day-specific, and sidecars use `devotional-intro-v1` freshness metadata so current targets refresh when the intro policy changes.
